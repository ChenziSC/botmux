...
export const messages: Record<string, string> = {
  ...
  'card.effort.scope': 'This session only · Change while idle; applies to the next message',
  'card.effort.pending': 'Saved · The next message resumes this session at the selected effort',
  'card.effort.saved': 'Session effort saved; applies to the next message.',
  ...
  'worker.empty_final_failed_quota': '⚠️ {cliName} reached a model-service quota or counter limit. This turn did not complete.\n{reason}\nWait for the service quota to recover or contact its administrator; signing in again will not resolve this limit.',
  'worker.empty_final_failed_rate_limit': '⚠️ {cliName} was rate limited. This turn did not complete.\n{reason}\nRetry after the service limit clears.',
