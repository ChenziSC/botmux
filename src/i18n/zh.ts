...
export const messages: Record<string, string> = {
  ...
  'card.effort.scope': '仅当前会话 · 空闲时可切换，下一条消息生效',
  'card.effort.pending': '已保存 · 下一条消息按所选强度继续原会话',
  'card.effort.saved': '已保存当前会话强度；下一条消息生效。',
  ...
  'worker.empty_final_failed_quota': '⚠️ {cliName} 的模型服务额度或限制计数已达上限，本轮未完成。\n{reason}\n请等待服务额度恢复，或联系模型服务管理员；重新登录不能解决此问题。',
  'worker.empty_final_failed_rate_limit': '⚠️ {cliName} 的模型请求受到频率限制，本轮未完成。\n{reason}\n请等待服务限制解除后再试。',
