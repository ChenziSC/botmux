 ...
 * a unified synchronous handle behind the existing async API. Reuse the
 * createRequire-based loader so inactive runtime branches are not statically
 * resolved by older Bun versions.
 */
